                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right pull-right">
                            <?=  Html::a( "<i class='material-icons'>add</i> Nuevo " .'Paquete', ['create'], ['class' => 'btn btn-success']) ?>
                        </div>
                    </div>
        ...
        'columns' => [
            ...
            //'ciudad',
                                ...
                                [
                                    ...
                                    'width'=>'200px',
                                    'template'=>'{view} {update} {delete}{imagenes}',
                                    'buttons'=>[
                                        ...
                                        'imagenes' => function ($url, $model, $key) {
                                            return Html::a('<i class="material-icons">photo_size_select_actual</i>', ['imagenes', 'id'=>$key], [
                                                'class'=>'btn btn-primary btn-round btn-just-icon',
                                                'title'=>'Agregar fotografias',
                                                'aria-label'=>'Agregar fotografias',
                                            ]);
                                        },
                                    ]
                                ],
