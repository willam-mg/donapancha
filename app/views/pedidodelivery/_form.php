        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <?= $form->field($model, 'direccion')->textInput(['maxlength' => true,'placeholder'=>'Introducir la descripci贸n del domicilio']) ?>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <?= $form->field($model, 'instrucciones')->textArea(['maxlength' => true,'placeholder'=>'Introducir alguna instrucci贸n (Opcional)']) ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <?= $form->field($model, 'tipo_pedido_id')->widget(Select2::classname(), [
                    ...
                    'options' => ['placeholder' => 'Seleccione el tip贸 de pedido'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ]
