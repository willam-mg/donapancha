...
/* @var $searchModel app\models\PreciodeliverySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Delivery precios';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="preciodelivery-index">
                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right pull-right">
                            <?=  Html::a( "<i class='material-icons'>add</i> Nuevo " .'Precio', ['create'], ['class' => 'btn btn-round btn-success']) ?>
                        </div>
                    </div>
