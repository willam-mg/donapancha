                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right pull-right">
                            <?=  Html::a( "<i class='material-icons'>add</i> Nuevo " .'Producto', ['create'], ['class' => 'btn btn-round btn-success']) ?>
                        </div>
                    </div>
                    <?php Pjax::begin(); ?>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value'=>function($model){
                                    if ($model->foto){
                                        return Html::img('@web/uploads'.\app\models\Producto::PATH.$model->foto, [
                                            'width'=>'200',
                                            'height'=>'200',
                                        ]);
                                    }
                            ...
                            'detalle',
                            'costo',
                            'categoria.nombre:text:Categoria',
                            'estado',
                            [
