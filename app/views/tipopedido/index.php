...
/* @var $searchModel app\models\TipopedidoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tipos de pedidos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tipopedido-index">
                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right pull-right">
                            <?=  Html::a( "<i class='material-icons'>add</i> Nuevo " .'Tipo', ['create'], ['class' => 'btn btn-round btn-success']) ?>
                        </div>
                    </div>
