                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <?php $form = ActiveForm::begin([
                                'action' => ['/reporte/pedidos-producto'],
                                'method' => 'get',
                                'options' => [
                        ...
                        'columns' => [
                            [
                                ...
                                'detail' => function ($model) {
                                    ...
                                    // $detalle = new ActiveDataProvider([
                                    //     'query' => $query,
                                    // ]);
                                    // $query->where([
                                    //     'pedido_delivery_id' => $model->id
                                    // ])->all();

                                    return $this->render('_detalle_pedidos', [
                                        'model' => $model,
                                    ]);
                                },
                                'expandOneOnly' => false,
                            ...
                            [
                                ...
                                'value'=>function($model) {
                                    return $model->cliente?$model->cliente->razon_social:$model->razon_social;
                                }
                            ],
                            [
                            ...
                            // 'asignacionMoto.fecha_entrega:text:Fecha entregado',
                            // 'asignacionMoto.hora_entrega:text:Hora entregado',
