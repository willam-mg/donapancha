...
function initMap(){
    let latitude = parseFloat($('#sucursaldelivery-latitude').val());
    let longitude = parseFloat($('#sucursaldelivery-longitude').val());
...
function addMarker(latLng){
    ...
    $('#sucursaldelivery-latitude').val(latLng.lat().toString());
    $('#sucursaldelivery-longitude').val(latLng.lng().toString());
}
